	...
	private JButton createIssueSaveButton() {
		...
		saveButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				currentIssue.setCreator(creatorField.getText().equals("") ? null : creatorField.getText());
				currentIssue.setResolver(resolverField.getText().equals("") ? null : resolverField.getText());
				currentIssue.setVerifier(verifierField.getText().equals("")  ? null : verifierField.getText());
